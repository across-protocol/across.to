import {CoinStackIcon, DashboardFastIcon, ShieldCheckIcon, SubscriptionStarIcon  } from '@/app/_components/icons'
    ...
    <section className={`relative ${sectionSpacing} pb-16 pt-6 sm:pb-20`}>
      ...
      <div className="mx-auto grid max-w-6xl gap-4 sm:gap-4 md:grid-cols-2">
        {featureCards.map((feature) => (
          ...
          >
            <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-aqua-100/10 text-aqua-100 p-3">
              <feature.Icon className="h-8 w-8" />
            </div>
            <h3 className="relative mt-6 text-xl font-semibold tracking-tight text-light-400 text-heading-4">
              {feature.title}
            </h3>
