...
export function GetStartedSection() {
  return (
    <section className="container mx-auto flex flex-col items-center gap-16 sm:gap-24">
      ...
      <Text variant="heading-1">Ready to get started?</Text>
      <div className="flex flex-row gap-6">
        <a
          href={INFORMATION_LINKS.docs.href}
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center justify-center rounded-full bg-teal-100/[.05] px-6 py-2 shadow-sm"
        >
          <Text variant="cap-case" className="text-teal-100 sm:text-sm md:text-sm">
            go to docs
          </Text>
        </a>
